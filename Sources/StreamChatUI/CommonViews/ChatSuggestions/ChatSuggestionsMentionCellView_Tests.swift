...
class ChatSuggestionsMentionCellView_Tests: XCTestCase {
    ...
    func test_emptyAppearance() {
        let view = ChatSuggestionsMentionCellView().withoutAutoresizingMaskConstraints
    ...
    func test_appearanceCustomization_usingAppearanceHook() {
        class TestView: ChatSuggestionsMentionCellView {}
