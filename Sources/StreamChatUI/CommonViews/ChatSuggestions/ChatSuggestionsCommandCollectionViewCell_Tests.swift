...
class ChatSuggestionsCommandCollectionViewCell_Tests: XCTestCase {
    ...
    func test_updateContent_whenCommandIsRecognized_commandIconImageIsUsed() {
        ...
        let view = ChatSuggestionsCommandCellView()
    ...
    func test_appearanceCustomization_usingAppearanceHook() {
        class TestView: ChatSuggestionsCommandCellView {}
    ...
    private func makeView(_ customView: ChatSuggestionsCommandCellView.Type? = nil) -> ChatSuggestionsCommandCellView {
        let view = customView != nil ? customView!.init() : ChatSuggestionsCommandCellView()
