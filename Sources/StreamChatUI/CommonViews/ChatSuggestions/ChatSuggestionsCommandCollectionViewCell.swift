...
public typealias ChatSuggestionsCommandCellView = _ChatSuggestionsCommandCellView<NoExtraData>

/// A view that displays the command name, image and arguments.
open class _ChatSuggestionsCommandCellView<ExtraData: ExtraDataTypes>: _View, UIConfigProvider {
