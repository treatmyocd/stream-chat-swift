...
public typealias ChatSuggestionsMentionCellView = _ChatSuggestionsMentionCellView<NoExtraData>

/// A View that is embed inside `UICollectionViewCell`  which shows information about user which we want to tag in suggestions
open class _ChatSuggestionsMentionCellView<ExtraData: ExtraDataTypes>: _View, UIConfigProvider {
...
open class _ChatMessageComposerMentionCollectionViewCell<ExtraData: ExtraDataTypes>: _CollectionViewCell, UIConfigProvider {
    ...
    open lazy var mentionView: _ChatSuggestionsMentionCellView<ExtraData> = uiConfig
        .messageComposer
