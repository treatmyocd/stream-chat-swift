...
public extension _UIConfig {
    struct MessageComposer {
        ...
        public var suggestionsMentionCellView: _ChatSuggestionsMentionCellView<ExtraData>.Type =
            _ChatSuggestionsMentionCellView<ExtraData>.self
        /// A view that displays the command name, image and arguments.
        public var suggestionsCommandCellView: _ChatSuggestionsCommandCellView<ExtraData>.Type =
            _ChatSuggestionsCommandCellView<ExtraData>.self
